...
یک مشاور همیشه در دسترس روی وبسایتتون که به مشتری‌ها کمک می‌کنه تصمیم‌گیری کنند و خریدشون رو تکمیل کنند.

${
  hasGoftino
    ? `
حالا که شما از گفتینو استفاده می‌کنید، می‌تونید گفتینو رو به یک ابزار هوشمند تبدیل کنید:
اولا نیازی به پشتیبان انسانی نخواهید داشت.
دوما اگر هم به هوش مصنوعی ۱۰۰٪ اعتماد ندارید، یک ابزار قدرتمند و هوشمند به روی پنل گفتینو بهتون می‌دیم که به پشتیبان شما کمک می‌کنه سریع‌تر و بهتر به مشتریان پاسخ بده.
`
    : ""
}
